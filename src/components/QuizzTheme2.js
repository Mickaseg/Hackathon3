...
const QuizzTheme1 = ({ questionsTheme2 }) => {
  ...
  const getAnswers = () => {
    axios
      .get(
        `${process.env.REACT_APP_BACK}/quizz/questions/${questionsTheme2[currentQuestionNumber]}/answers`
      )
      .then((res) => res.data)
            ...
            <div className="bloc-head-gauche">
              ...
              <div className="bloc-head-gauche-bloc">
                <div className="question-bloc">
                  {questionsTheme2[currentQuestionNumber] !== undefined
